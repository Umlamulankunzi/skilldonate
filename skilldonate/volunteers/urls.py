...
urlpatterns = [
    ...
    path("profile/<int:volunteer_id>/", views.profile, name="volunteer-profile"),
    path("profile/update/<int:volunteer_id>/", views.update_profile,
          name="volunteer-profile-update"),

    path("skill_required/show_interest/<int:skill_required_id>/",
